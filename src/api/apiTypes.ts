...
/**
 * @description Interface que especifica a estrutura de uma página de dados retornada pela API.
 * @template Data Representa o tipo dos dados contidos na página.
 */
